...
app = FastAPI(
    title="iDReader API & Developer Portal",
    description="Multi-agent document OCR and developer API key management",
    version="1.0.0"
)
...
class KeyGenerationRequest(BaseModel):
    client_name: str = Field(..., min_length=2, max_length=50, description="Developer or App Name")
...
# Endpoint: Generate new API Key from Frontend
@app.post("/api/v1/generate-key")
async def generate_new_key(req: KeyGenerationRequest):
...
# Endpoint: Extract Document Details
